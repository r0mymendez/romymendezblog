...
Trello es una aplicación basada en la metodología Kanban y permite gestionar tu trabajo de forma colaborativa. Su version gratuita tiene tableros personales ilimitados, tarjetas ilimitadas al igual que listas y hasta 10MB por archivo adjunto. ![](https://cdn-images-1.medium.com/max/1600/1*9okP8Tt4RBWfKsiKctz31w.jpeg)
...
![](https://cdn-images-1.medium.com/max/1600/1*glnYc_G2fDzgIWxwjNsqZg.png) source image : imagen obtenida en <https://quire.io/>
...
![](https://cdn-images-1.medium.com/max/1600/1*yPW-DVfORD5WWEu7yvy_IA.png) imagen obtenida en <https://asana.com/es>
...
![](https://cdn-images-1.medium.com/max/1600/1*sYLAXPKHKFFt8IvgSVSbAw.png) imagen obtenida en <https://clickup.com/welcome>
...
Gitmind es una herramienta para realizar diagramas de mapas mentales y la misma es gratuita ![](https://cdn-images-1.medium.com/max/1600/1*b-qnKf5hXnVlfpGRdJgomA.png)
...
![](https://cdn-images-1.medium.com/max/1600/1*smMXTJQqmYN-3qhMdlWtPQ.png) imagen obtenida de mi perfil de habitica
...
![](https://cdn-images-1.medium.com/max/1600/1*ThDeyU6M_760bo79HARHSw.png) Imagen obtenida de mi cuenta de <https://www.draw.io/>
...
Discord es otra plataforma para crear grupo de chats, en el cual también puedes organizar las conversaciones en canales por temas ![](https://cdn-images-1.medium.com/max/1600/1*RNly5iWJiU6xclQEO60IgQ.png)
