...
description: |
  In the following article, we will explore a libraries to add colors and styles to R DataFrames.
categories:
  - R
  - Data
  - DataViz
...
# The following code create a barplot with viridis palette colors
